...
/**
 * Representation of attributes for local variables in a code with generics
 * signature.
 * 
 * @author nono
 ...
 *          Exp $
 */
public class LocalVariableTypeTableAttribute extends AttributeFileInfo {
   ...
   */
  public static final String attributeName = "LocalVariableTypeTable";

  public LocalVariableTypeTableAttribute() {
  }

  public LocalVariableTypeTableAttribute(ClassFile cf) {
  ...
  public void write(DataOutputStream out) throws IOException {
    ...
    while (it.hasNext()) {
      ((VariableInfo) it.next()).write(out);
    }
    classFile.dispatch(new ClassFileIOEvent(classFile, ClassFileIOEvent.WRITE,
